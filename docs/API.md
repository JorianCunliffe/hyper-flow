...
An owner can reach recovery controls from the revoked-workspace screen. Downloaded exports remain outside browser cache invalidation. Resume does not automatically resume the other service or reconnect providers. No portable-export restore or whole-account erasure guarantee is claimed.
