...
| P11 | Complete REST parity and SaaS operations | In progress: first account/API release live; lifecycle and full parity remain | Cross-cutting from P01; final audit after selected product phases | [P11](implementation/P11.md) |
